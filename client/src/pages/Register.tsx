    ...
    return (
      <main className="max-w-[500px] flex flex-col gap-3 justify-center items-center m-auto mt-14 mb-28">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-cyan-500 text-white portrait:w-[80%] font-semibold p-[10px] w-[75%] rounded-md  duration-300 ease-in-out hover:text-black hover:bg-white hover:border-cyan-500"
            disabled={loading}
          >
            Register
          </button>
